 ...
 */
package com.sunrun.sunrunframwork.db.orm.dao;
...
import com.sunrun.sunrunframwork.db.AbBasicDBDao;
import com.sunrun.sunrunframwork.db.orm.AbTableHelper;
import com.sunrun.sunrunframwork.db.orm.annotation.ActionType;
import com.sunrun.sunrunframwork.db.orm.annotation.Column;
import com.sunrun.sunrunframwork.db.orm.annotation.Id;
import com.sunrun.sunrunframwork.db.orm.annotation.Relations;
import com.sunrun.sunrunframwork.db.orm.annotation.RelationsType;
import com.sunrun.sunrunframwork.db.orm.annotation.Table;
...
//					+ this.idColumn + " = '" + id + "'");
	 ...
	 * @param clazz  返回的对象类型
	 * @return the list
	 * @see com.ab.db.orm.dao.AbDBDao#rawQuery(String, String[])
	 */
	@Override
...
//			AbLogUtil.e(AbDBDaoImpl.class, "[rawQuery] from DB Exception.");
	 ...
	 * @see com.ab.db.orm.dao.AbDBDao#isExist(String, String[])
	 */
	@Override
...
//			AbLogUtil.e(AbDBDaoImpl.class, "[isExist] from DB Exception.");
	 ...
	 * @return the list
	 * @see com.ab.db.orm.dao.AbDBDao#queryList(String[], String, String[], String, String, String, String)
	 */
	@Override
	public List<T> queryList(String[] columns, String selection,
			...
			try {
				lock.lock();
				checkDBOpened();
				//Logger.D( "[queryList] from "+this.tableName+" where "+selection+"("+selectionArgs+")"+" group by "+groupBy+" having "+having+" order by "+orderBy+" limit "+limit);
...
//				AbLogUtil.e(AbDBDaoImpl.class, "[queryList] from DB Exception");
     ...
     * @param selectionArgs the selection args
     * @return the list
     * @see com.ab.db.orm.dao.AbDBDao#queryList(String, String[])
     * @author: amsoft.cn
     */
	@Override
	 ...
	 * @return the long
	 * @see com.ab.db.orm.dao.AbDBDao#insert(Object)
	 */
	@Override
	 ...
	 * @param flag the flag
	 * @return the long
	 * @see com.ab.db.orm.dao.AbDBDao#insert(Object, boolean)
	 */
	@Override
...
//				AbLogUtil.d(AbDBDaoImpl.class, "[insert] into DB Exception.");
	 ...
	 * @see com.ab.db.orm.dao.AbDBDao#insertList(List)
	 */
	@Override
	 ...
	 * @param flag the flag
	 * @return the long[] 插入成功的数据ID
	 * @see com.ab.db.orm.dao.AbDBDao#insertList(List, boolean)
	 */
	@Override
...
//			AbLogUtil.d(AbDBDaoImpl.class, "[delete] DB Exception.");
	 ...
	 * @param ids the ids
	 * @return the int
	 * @see com.ab.db.orm.dao.AbDBDao#delete(Integer[])
	 */
	@Override
	 ...
	 * @return the int
	 * @see com.ab.db.orm.dao.AbDBDao#delete(String, String[])
	 */
	@Override
	public int delete(String whereClause, String[] whereArgs) {
		...
		try {
			...
			if(!EmptyDeal.isEmpy(mLogSql)){
				mLogSql +=" where ";
			}
			//Logger.E( "[delete]: delete from " + this.tableName + mLogSql);
...
//			AbLogUtil.d(AbDBDaoImpl.class, "[delete] DB Exception.");
	 ...
	 * @param entity the entity
	 * @return the int 影响的行
	 * @see com.ab.db.orm.dao.AbDBDao#update(Object)
	 */
	@Override
	public int update(T entity) {
		...
		try {
			...
			String where = this.idColumn + " = ?";
			String id =  String.valueOf(cv.get(this.idColumn).toString());
			//set sql中不能包含主键列
...
//			AbLogUtil.d(AbDBDaoImpl.class, "[update] DB Exception.");
	 ...
	 * @param entityList the entity list
	 * @return the int 影响的行
	 * @see com.ab.db.orm.dao.AbDBDao#updateList(List)
	 */
	@Override
...
//				AbLogUtil.d(AbDBDaoImpl.class, "[update] DB Exception.");
	 ...
	 * @param selectionArgs the selection args
	 * @return the list
	 * @see com.ab.db.orm.dao.AbDBDao#queryMapList(String, String[])
	 */
	@Override
...
//			AbLogUtil.e(AbDBDaoImpl.class, "[queryMapList] from DB exception");
	 ...
	 * @param selectionArgs the selection args
	 * @return the int
	 * @see com.ab.db.orm.dao.AbDBDao#queryCount(String, String[])
	 */
	@Override
...
//    	   AbLogUtil.e(AbDBDaoImpl.class, "[queryCount] from DB exception");
	 ...
	 * @param sql the sql
	 * @param selectionArgs the selection args
	 * @see com.ab.db.orm.dao.AbDBDao#execSql(String, Object[])
	 */
	@Override
